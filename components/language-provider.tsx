...
const defaultEn = {
  ...
  craftDesc: "Every Terralume piece is designed with an uncompromising focus on material integrity, tactile depth, and enduring aesthetics. We believe true luxury is experienced — in the texture, the weight, and in how a space quietly finds its harmony.",
  ...
  newsletterDesc: "Receive early access to new collections, limited pieces, and thoughtfully curated moments of inspiration.",
  emailPlaceholder: "Enter your email",
  joinNowBtn: "Become a Member",
  newsletterNote: "Enjoy 10% off your first order as a welcome gesture.",
  ...
  imprintCompanyText: "Terralume Living UG<br />Am Irscher Hof 73<br />54294 Trier<br />Germany",
  imprintContactTitle: "Contact",
  imprintContactText: "Phone: +49 175 92 777 97<br />Email: info@terralumeliving.com",
  imprintRepresentedTitle: "Represented by",
  imprintRepresentedText: "Mubashar Ahmad Khan, CEO",
  imprintRegisterTitle: "Register Entry",
  imprintRegisterText: "Amtsgericht Wittlich<br />Registration Number: will be provided once registered",
  imprintVatTitle: "VAT ID",
  imprintVatText: "Sales tax identification number:<br />(Will be provided once applied and received)",
...
const defaultDe = {
  ...
  craftDesc: "Jedes Terralume-Stück entsteht mit einem kompromisslosen Anspruch an Materialechtheit, haptische Tiefe und zeitlose Ästhetik. Wahrer Luxus zeigt sich im Gefühl — in der Textur, im Gewicht und in der Harmonie, die ein Raum ausstrahlt.",
  ...
  newsletterTitle: "Werden Sie Teil des Terralume-Kreises",
  newsletterDesc: "Erhalten Sie bevorzugten Zugang zu neuen Kollektionen, limitierten Stücken und sorgfältig kuratierten Momenten der Inspiration.",
  emailPlaceholder: "Ihre E-Mail-Adresse",
  joinNowBtn: "Dem Kreis beitreten",
  newsletterNote: "Als Willkommensgeschenk erhalten Sie 10% auf Ihre erste Bestellung.",
  ...
  imprintCompanyText: "Terralume Living UG<br />Am Irscher Hof 73<br />54294 Trier<br />Deutschland",
  imprintContactTitle: "Kontakt",
  imprintContactText: "Telefon: +49 175 92 777 97<br />E-Mail: info@terralumeliving.com",
  imprintRepresentedTitle: "Vertreten durch",
  imprintRepresentedText: "Mubashar Ahmad Khan, Geschäftsführer",
  imprintRegisterTitle: "Registereintrag",
  imprintRegisterText: "Amtsgericht Wittlich<br />Registernummer: wird nachgereicht",
  imprintVatTitle: "Umsatzsteuer-ID",
  imprintVatText: "Umsatzsteuer-Identifikationsnummer:<br />(Wird nachgereicht)",
